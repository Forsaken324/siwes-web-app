...
const CarDetails = () => {
  ...
  return (
    <div className="flex flex-wrap justify-start ml-5 mr-5 md:ml-10 lg:ml-20 xl:ml-0 xl:justify-center gap-30 mt-50">
      {car ? (
        <>
          <motion.div initial={{scale: 0}} animate={{scale: 1}} transition={{duration: 0.6, ease: 'easeIn'}} className="w-[833.94px]">
            ...
            <div>
              <div
                ...
                ref={carImgRef}
              ></div>
              <h2 className="text-black dark:text-white font-bold text-[30px] mt-4">
                {car.brand} {car.model}
              </h2>
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-5 mt-15">
                <div className="flex items-center justify-center flex flex-col lg:w-[197px] h-[80px] bg-v-light-gray rounded-xl dark:bg-gray-900">
                  <img
                ...
                <div className="flex items-center justify-center flex flex-col lg:w-[197px] h-[80px] bg-v-light-gray rounded-xl dark:bg-gray-900">
                  <img
                    ...
                    className="h-[20px]"
                  />
                  <p className="font-bold dark:text-gray-300">{car.fuel_type}</p>
                </div>
                <div className="flex items-center justify-center flex flex-col lg:w-[197px] h-[80px] bg-v-light-gray rounded-xl dark:bg-gray-900">
                  <img
                    src={assets.carIcon}
                    ...
                    className="h-[20px]"
                  />
                  <p className="font-bold dark:text-gray-300">{car.transmission}</p>
                </div>
                <div className="flex items-center justify-center flex flex-col lg:w-[197px] h-[80px] bg-v-light-gray rounded-xl dark:bg-gray-900">
                  <img
                    ...
                    className="h-[20px]"
                  />
                  <p className="font-bold dark:text-gray-300">{car.location}</p>
                </div>
              </div>
              <div className="mt-6">
                <h3 className="font-bold text-[19.53px] dark:text-gray-300">Description</h3>
                <p className="text-sm text-gray-400">{car.description}</p>
              </div>
              <div className="mt-6">
                <h3 className="font-bold text-[19.53px] mb-5 dark:text-gray-300">Features</h3>
                <div className="flex gap-2 text-sm md:text-base">
                  <div className="flex flex-col gap-3">
                    {car.features.slice(0, 2).map((feature, index) => (
                      <p key={index} className="flex items-start gap-2 text-sm dark:text-gray-400">
                  ...
                  <div className="flex flex-col gap-3">
                    {car.features.slice(2).map((feature, index) => (
                      <p key={index} className="flex items-start gap-2 dark:text-gray-400">
                        <img src={assets.check_icon} alt="tic-icon" /> {feature}
                      </p>
                    ))}
                  </div>
          ...
          <motion.div initial={{scale: 0}} animate={{scale: 1}} transition={{duration: 0.6, ease: 'easeIn'}} className="flex items-center flex-col w-[310px] h-[400px] rounded-xl shadow shadow-xl dark:bg-gray-900">
            ...
            <form
              ...
              id="book-car-form"
              className="flex flex-col justify-center dark:text-gray-400"
            >
