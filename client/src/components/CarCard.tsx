...
const CarCard = ({car}: CarCardProps) => {
  ...
  return (
    <div className='h-[283px] w-[317px] bg-white dark:bg-gray-900 rounded-xl shadow shadow-xl dark:shadow-lg dark:shadow-gray-800'>
        ...
        <div>
            <div className="pl-3 pt-2">
                <h3 className="text-black dark:text-white font-bold">{car.brand} {car.model}</h3>
                <p className="text-gray-400 text-[12px]">{car.category} {car.year}</p>
            </div>
            <div className="flex gap-10 p-3 text-gray-400">
                <div>
