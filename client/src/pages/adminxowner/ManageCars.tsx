...
const ManageCars = () => {
  ...
  return (
    <div>
      <h1 className="text-black dark:text-white text-[26px]">Manage Cars</h1>
          ...
          <div className="overflow-x-auto scroll-thin">
            <table className="w-full min-w-[929px] border-separate border-spacing-0 rounded-lg rounded rounded-full mt-10 text-gray-400 border border-gray-400/40">
              <thead className="border border-gray-400/40 h-[60px]">
                <tr>
                  <th className="w-[400px] text-start dark:text-white pl-8 border border-r-0 border-t-0 border-l-0 border-gray-400/40">
                    Car
                  </th>
                  <th className="text-start dark:text-white w-[150px] border border-r-0 border-t-0 border-l-0 border-gray-400/40">
                    Category
                  </th>
                  <th className="text-start dark:text-white w-[150px] border border-r-0 border-t-0 border-l-0 border-gray-400/40">
                    Price
              ...
              <tbody>
                {cars.map((car, index) => (
                  <tr className="border border-gray-400/40 h-[73px]">
                    ...
                    <td className="text-black dark:text-gray-300 border border-r-0 border-t-0 border-l-0 border-gray-400/40">
                      {car.category}
                    </td>
                    <td className="text-sm text-black dark:text-gray-300 border border-r-0 border-t-0 border-l-0 border-gray-400/40">
                      {currency}
                      {car.pricePerDay}/day
                    </td>
