...
const SearchHeader = () => {
  ...
  return (
    <div className="flex flex-col gap-4 w-full h-[327px] items-center justify-center p-5 text-gray-400 bg-home-gray mt-40">
        ...
        <div className="flex items-center justify-between w-[672px] h-[50px] rounded-full bg-white shadow shadow-lg">
            <div className="flex items-center gap-3 ml-5 w-[90%]">
                <img src={assets.search_icon} alt="search-icon" />
                <input type="text" placeholder="Search by make, model, or features" value={searchValue} onChange={(e) => setSearchValue(e.target.value)} className="w-full focus:outline-none" />
            </div>
